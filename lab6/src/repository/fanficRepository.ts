...
export const update = async (
  ...
  await sequelize.transaction(async (t) => {
    ...
    if (fanfic.description !== undefined)
      fields.description = fanfic.description
    if (fanfic.restriction !== undefined)
      fields.restriction = fanfic.restriction
...
export const getFanficsFiltered = async (
  ...
  const genreInclude: any = {
    ...
    through: { attributes: [] },
    ...(genre
      ? { where: { name: { [Op.iLike]: genre } }, required: true }
      : {}),
  }
