...
import { getAll, getById, create, update, deleteById, getFanficsFiltered, FanficFilterOptions } from '../repository/fanficRepository.ts';
...
export const getFanficsFilteredAsync = async (opts: FanficFilterOptions) => {
    return await getFanficsFiltered(opts);
};
